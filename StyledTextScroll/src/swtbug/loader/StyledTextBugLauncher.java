...
public class StyledTextBugLauncher
{
  public static void main(String[] args) throws Throwable
  {
    ...
    try
    {
      try
      {
        ...
        Class<?> c = Class.forName("swtbug.StyledTextBug", true, cl);
    ...
    {
      System.err
          .println("Launch failed: Failed to find main class - swtbug.StyledTextBug");
    }
  ...
  {
    ClassLoader parent = StyledTextBugLauncher.class.getClassLoader();
    URL.setURLStreamHandlerFactory(new RsrcURLStreamHandlerFactory(parent));
    String swtFileName = getSwtJarName();
    try
    {
      URL intraceFileUrl = new URL("rsrc:styledtextscroll-wrapper.jar");
